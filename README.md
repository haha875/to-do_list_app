...
#### 功能演示
![alt text](<屏幕截图 2026-09-22 192041.png>)
![深色模式](屏幕截图192409.png)
![alt text](<屏幕截图 2026-09-22 192329.png>)
![alt text](<屏幕截图 2026-09-22 192340.png>)
![alt text](<屏幕截图192445.png>)

#### 提示词设计
我想在这个git仓库中开发一个任务管理系统，功能需求如下：
任务增删改查：标题必填、描述选填
三种状态：待办 / 进行中 / 完成
优先级三档：高（红）、中（黄）、低（绿）
看板视图：三列卡片，拖拽即改状态
